            ...
            <div class="row">
		        <div class="contact-intro col-lg-8 mx-lg-auto mb-5 text-center">
			        ...
			        <div class="speech-bubble bg-white p-4 p-lg-5 shadow-sm">
				        <p class="text-start mb-3">I'm currently taking on freelance work. If you are interested in hiring me for your project please use the form below to get in touch. Want to know how I work and what I can offer? Check out my <a class="text-link" href="projects.html">project case studies</a> and <a class="text-link" href="resume.html">resume</a>.</p>
			        ...
			        <form id="contact-form" class="contact-forms" method="post" action="#">
				        ...
				        <div class="row g-3">                                                           
			                ...
			                <div class="col-12">
			                 ...
			                 <div class="col-12">
			                    <button type="submit" class="btn w-100 btn-primary py-2">Send It</button>
			                </div>                           
			            </div><!--//form-row-->
			        </form>
		        </div>
